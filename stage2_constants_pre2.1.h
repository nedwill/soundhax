...
#define FS_READ_FILE 0x002C812C
#define GSP_GX_CMD4 0x002EAEAC
#define GSP_FLUSH_DATA_CACHE 0x002E5148

#define SRV_SESSIONHANDLE 0x00370BF8
#define SRV_SEMAPHORE 0x00370BE8

#define THREAD8_EVENT_HANDLE 0x003AC300
#define THREAD8_OBJ 0x003AD650
